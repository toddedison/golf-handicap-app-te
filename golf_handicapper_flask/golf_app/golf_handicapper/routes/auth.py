...
# ── Login / Logout  (SessionsController) ────────────────────────────────────
...
# ── Sign-up  (UsersController#new + #create) ────────────────────────────────
...
def signup():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            current_app.logger.warning(f'Activation email failed: {e}')
        flash('Please check your email to activate your account.', 'info')
        return redirect(url_for('static_pages.home'))
    return render_template('auth/signup.html', form=form)


# ── Account activation  (AccountActivationsController#edit) ─────────────────
...
# ── Password reset  (PasswordResetsController) ──────────────────────────────
